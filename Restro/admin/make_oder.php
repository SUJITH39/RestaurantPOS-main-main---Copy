              ...
              <form method="POST" enctype="multipart/form-data">
                ...
                ?>
                  <div class="form-row">
                    ...
                    <div class="col-md-6">
                      <label>Product Category</label> <!-- New field for prod_category -->
                      <input type="text" readonly name="prod_category" value="<?php echo $prod->prod_category; ?>" class="form-control">
                    </div>
                  </div>
                  <div class="form-row">
                    <div class="col-md-6">
