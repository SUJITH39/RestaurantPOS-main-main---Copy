...
if (isset($_POST['addProduct'])) {
  ...
  if (empty($_POST["prod_code"]) || empty($_POST["prod_name"]) || empty($_POST['prod_desc']) || empty($_POST['prod_price']) || empty($_POST['prod_category'])) {
    ...
    $postQuery = "INSERT INTO rpos_products (prod_id, prod_code, prod_name, prod_img, prod_desc, prod_price, prod_offer, prod_category) VALUES(?,?,?,?,?,?,?,?)";
    $postStmt = $mysqli->prepare($postQuery);
    // Bind parameters
    $rc = $postStmt->bind_param('ssssssss', $prod_id, $prod_code, $prod_name, $prod_img, $prod_desc, $prod_price, $prod_offer, $prod_category);
    $postStmt->execute();
            ...
            <div class="card-body">
              <form method="POST" enctype="multipart/form-data">
                ...
                <div class="form-row">
                  ...
                  <div class="col-md-6">
                    <label>Product Offer</label> <!-- New input for prod_offer -->
                    <input type="text" name="prod_offer" class="form-control" value="">
                  </div>
                </div>
                <hr>
                <div class="form-row">
